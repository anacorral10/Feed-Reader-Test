...
$(function() {
    ...
    */
    ...
    describe('The menu', function(){
         ...
         * the CSS to determine how the hiding/showing of the 
         * menu element was performing.
         */
    ...
    describe('Initial Entries', function(){
        /* The "Initial Entries" test suite ensures when the loadFeed
    ...
    describe('New Feed Selection', function(){
        /* The "New Feed Selection" test suite that ensures when 
         * a new feed is loaded by the loadFeed function that the 
